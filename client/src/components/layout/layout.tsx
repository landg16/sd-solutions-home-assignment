        ...
        <div className='container mx-auto flex h-16 items-center px-4'>
          <div className='mr-4 flex justify-between w-full'>
            <div className='flex items-center'>
              <Link to='/' className='mr-6 flex items-center gap-3 space-x-2 group font-bold'>
                ...
                <span className='hidden md:block'>Task Management Dashboard</span>
                <span className='block md:hidden'>TMD</span>
              </Link>
